    ...
    <table class="table table-hover">
       <thead class="table-primary">
        ...
        <tbody>
          ...
          commandSQL = "SELECT * FROM tbform WHERE Name LIKE '%"&search&"%'"

          set resultObj = conn.execute(commandSQL)


					If resultObj.EOF = false Then
						' true
						Response.Write "<strong>Resultado...</strong>"
					Else
						' false
						Response.Write "Nenhum resultado encontrado para: <strong>" & search & "</strong> - <small><i><strong>Entre com dados validos</strong></i></small>"
